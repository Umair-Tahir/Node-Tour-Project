...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  //1) Get user based onn Posted email
  ...
  const message = `Forgot your passowrd? Submit a PATCH request with your new password
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  //2) Checl if posted current passwrod is correct
